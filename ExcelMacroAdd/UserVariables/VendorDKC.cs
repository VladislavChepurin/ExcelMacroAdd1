...
{
    [Serializable]
    public class VendorDKC : ICurrentVendor
    {
        [XmlAttribute("vendor")]
        ...
        public VendorDKC(string vendorAttribute, string formula_1, string formula_2, string formula_3, int discont, string date)
        {
