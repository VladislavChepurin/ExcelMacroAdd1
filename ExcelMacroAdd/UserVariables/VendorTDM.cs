...
{
    [Serializable]
    public class VendorTDM : ICurrentVendor
    {
        [XmlAttribute("vendor")]
        ...
        public VendorTDM(string vendorAttribute, string formula_1, string formula_2, string formula_3, int discont, string date)
        {
