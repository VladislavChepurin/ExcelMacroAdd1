...
{
    [Serializable]
    public class VendorEKF : ICurrentVendor
    {
        [XmlAttribute("vendor")]
        ...
        public VendorEKF(string vendorAttribute, string formula_1, string formula_2, string formula_3, int discont, string date)
        {
