...
namespace Searilizator
{
    ...
    {  
        static void Main()
        {
            var appSettings = new AppSettings(Resources(), ResourcesForm2(), ResourcesForm4());
        ...
        internal static ResourcesForm2 ResourcesForm2()
        {
        ...
        internal static ResourcesForm4 ResourcesForm4()
        {
